...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct  4 16:03:13 2019
...
random.seed(7) #create seed for random number generation 
...
#plt.plot(proportion_plot[0],proportion_plot[1])
#plt.plot(proportion_plot[0],proportion_plot[2])

#plt.plot(proportion_plot[0],proportion_plot[3])
    
#plt.grid()
#plt.xlabel('Time')
#plt.ylabel('Haplotype Proportion')
#plt.show()
...
ax2.plot(proportion_plot[0],proportion_plot[3])
