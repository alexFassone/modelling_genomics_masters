...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct  7 09:40:06 2019
...
def check_transfer(current_hospital, symmetric_rate, rate_value):
    
    #potentially make global to stop recalculations
    
    if symmetric_rate == True:
        transfer_matrix = [[0, rate_value], 
                           [rate_value, 0]]
    else:
        ...
        for i in range(0, no_hospitals):
            for j in range(0, int(trees_per_hospital[i])):
                ...
                for k in range(0, haplotypes_per_tree):
                    ...
                    transfer = check_transfer(i, symmetric_transfer_rate, transfer_rate)
...
simulation(hospitals, 300, 0.01, True, 0.001)