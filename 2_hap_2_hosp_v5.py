...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct  7 10:17:39 2019
...
ini_trees_per_hospital = [1, 1, 4, 20]
...
def simulation(hospitals, t_max, mutation_rate, symmetric_transfer_rate, transfer_rate):
    ...
    proportion_plot[1].append(haplotype_proportion[0][0][0])
    proportion_plot[2].append(haplotype_proportion[0][1][0])
    proportion_plot[3].append(haplotype_proportion[1])
...
simulation(hospitals, 50, 0.1, True, 0.1)